...
const BONUS_JOKES = [
    "אלינור: 'המורה שרית, את תענישי מישהו על משהו שהוא לא עשה?' | המורה: 'ברור שלא' | אלינור: 'יופי, כי לא עשיתי שיעורי בית!' 😂",
    "אביב: 'אלינור, למה גלגל ים לשיעור חשבון?' | אלינור: 'כי המורה שרית אמרה שהיום אנחנו צוללות עמוק לחומר!' 🌊",
    "אלינור: 'אביב, את יודעת למה עומר יושבת בפינה כשיש לה קר? כי בפינה תמיד יש 90 מעלות!' 📐❄️",
    "המורה שרית: 'אלינור, איך קוראים למי שממשיך לדבר וכולם הפסיקו להקשיב לו?' | אלינור: 'המורה שרית!' 🗣️🤫",
    "המורה שרית: 'אלינור, אם יש לי 5 אבטיחים ביד אחת ו-6 בשנייה, מה יש לי?' | אלינור: 'ידיים ממש גדולות, המורה!' 🍉✋"
];

const TEASE_MSGS = [
    '🎁 פרס שווה במיוחד!',
    'אלינור: "המורה, מה יש בתיבה?!" 🧐',
    '💎 תכשיט יוקרתי מחכה לך...',
    'אביב: "אלינור, תפתחי כבר!" ✨',
    '🌊 ריח הים בא מהתיבה...',
    'עומר: "אני מקווה שיש שם אוכל!" 🍕',
    '👀 מה יש בפנים?! לחץ!',
    '🏆 הצלחת! הפרס מחכה לך!',
];
...
function handleChestClick() {
    ...
    void clicker.offsetWidth; // force reflow
